...
[Link to youtube video](https://youtu.be/iKqZXKEQSnw?si=Ecj99s7A9m8SFMpY)
...
5. Run deck gateway sync: `deck gateway sync --konnect-token $KONNECT_TOKEN --select-tag rate-limiting-adv-example`
